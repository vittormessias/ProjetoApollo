...
public class NotificacoesPublicoFragment extends Fragment {

    Button btn1, btnImgMitoseLendas1, btnVermelho1, btn2, btnImgRobert, btnVermelho2, btn3, btnImgVitor1, btnVermelho3, btn4, btnImgYasmin1, btn5, btn6, btnImgVitor, btn7, btnImgGustavo, btn8, btnImgYasmin, btn9;


    public NotificacoesPublicoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.notificacoes_publico_layout, container, false);

        btn1 = view.findViewById(R.id.btn1);
        btnImgMitoseLendas1 = view.findViewById(R.id.btnImgMitoseLendas1);
