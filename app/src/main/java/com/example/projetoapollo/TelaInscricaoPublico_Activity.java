...
public class TelaInscricaoPublico_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_inscricao_publico_layout);
    ...
    private void validaCampo() {
        ...
        if (isCampoVazio(nomeUsuario)) {
            ...
            resp = true;
        } else if (isCampoVazio(nomeLogin)) {
            txtCadLogin.requestFocus();
            resp = true;
        } else if (!isEmailValido(nomeEmail)) {
            txtCadEmail.requestFocus();
            resp = true;
        } else if (isCampoVazio(nomeSenha)) {
            txtCadSenha.requestFocus();
            resp = true;
        } else if (isCampoVazio(nomeConfSenha)) {
    ...
    public void voltarJanelaPublico(View view) {
        Intent voltarJanelaPublico = new Intent(getApplicationContext(), LoginPublico_Activity.class);
